...
DIRECTOR_SYSTEM_PROMPT = (
    ...
    "strategy for the chosen state — the real argument, not just which Lean "
    "tactic to try next.\n"
    "- If you are not fully confident of the exact Mathlib lemma name or its "
    "argument order, do not guess a specific identifier — prefer a search "
    "tactic such as `apply?` or `exact?`, which finds and verifies the step "
    "itself, over naming a lemma you are unsure of. Which tactic best fits "
    "the goal in front of you is your call.\n"
