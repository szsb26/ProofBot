...
DIRECTOR_SYSTEM_PROMPT = (
    ...
    "where to focus next.\n\n"
    "Rules:\n"
    "- Whatever you write in \"reasoning\" is stored against the chosen "
    "state and shown back to you on later turns as that state's last stated "
    "plan. Nothing else about this turn's thinking is carried forward.\n"
